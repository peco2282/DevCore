...
class PacketInternalImpl : PacketInternal {
  ...
  override fun createFakeEntityBuilder(player: Player, type: EntityType, location: Location): FakeEntityBuilder {
    throw UnsupportedOperationException("FakeEntityBuilder is not yet implemented for v1_21_11")
  }

  override fun sendRawPacket(player: Player, channel: String, buf: FriendlyByteBuf) {
    throw UnsupportedOperationException("sendRawPacket is not yet implemented for v1_21_11")
  }

  override fun sendTitle(player: Player, title: String, subtitle: String, fadeIn: Int, stay: Int, fadeOut: Int) {
    throw UnsupportedOperationException("sendTitle is not yet implemented for v1_21_11")
  }

  override fun sendActionBar(player: Player, message: String) {
    throw UnsupportedOperationException("sendActionBar is not yet implemented for v1_21_11")
  }
  ...
  override fun sendSound(
    ...
    throw UnsupportedOperationException("sendSound is not yet implemented for v1_21_11")
  }
}
